...
csv_file_path = r'C:/Users/devka/OneDrive/Desktop/Face-Recognition-Attendance-System-main/Attendance.csv'
def manually_fill():
    global sb
    sb = tk.Tk()
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"{}"'.format(csv_file_path))
